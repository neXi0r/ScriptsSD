...
state_addons.innerHTML += '<button id="myButton_reachout" style="white-space: nowrap" type="button" title="" data-original-title="(Teams Reach out) Copy teams reach out message." aria-expanded="false">Reach out</button>';
